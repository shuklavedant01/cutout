"""
Audio Processing Pipeline - Main Orchestrator
...
Usage:
    python pipeline.py <directory_path>
    
Example:
    python pipeline.py c:/Users/aksha/cutout
"""
import sys
import os
...
def main():
    ...
    if len(sys.argv) < 2:
        print("❌ Usage: python pipeline.py <directory_path>")
        print("\nExample:")
        print("  python pipeline.py c:/Users/aksha/cutout")
        sys.exit(1)
